...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-#81gh2aaspfkhhl!i56!7n%m6!$($92^kkpppi$%esjkmk1&gh')
...
EMAIL_PORT = 1025
DEFAULT_FROM_EMAIL = 'Veterinaria VET LOVE <noreply@vetlove.com>'
...
ADMIN_SITE_HEADER = 'Administración de Veterinaria VET LOVE'
ADMIN_SITE_TITLE = 'Veterinaria VET LOVE'
...
EPAYCO_P_CUST_ID_CLIENTE = config('EPAYCO_P_CUST_ID_CLIENTE', default='')
EPAYCO_P_KEY = config('EPAYCO_P_KEY', default='')
EPAYCO_URL = 'https://secure.epayco.co/validation/v2/html/checkout.php'
EPAYCO_TEST = config('EPAYCO_TEST', default=True, cast=bool)
EPAYCO_RESPONSE_URL = config('EPAYCO_RESPONSE_URL', default='')
EPAYCO_CONFIRMATION_URL = config('EPAYCO_CONFIRMATION_URL', default='')